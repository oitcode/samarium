<div class="bg-white p-3">
  ...
  <div class="form-group">
    <label for="">Phone <span class="text-muted">(optional)</span></label>
  ...
  <div class="form-group">
    <label for="">Address <span class="text-muted">(optional)</span></label>
    <input type="text" class="form-control" wire:model.defer="address">
    @error('email') <span class="text-danger">{{ $message }}</span> @enderror
  </div>

  <div class="form-group">
    <label for="">PAN Number <span class="text-muted">(optional)</span></label>
