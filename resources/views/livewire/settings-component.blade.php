  ...
  <div class="card-body-rm">
    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <div class="mb-4">
          <h3 class="h5">Sale payment types</h3>
          <div>
            @foreach ($saleInvoicePaymentTypes as $saleInvoicePaymentType)
              <span class="badge-rm badge-light-rm border p-2">
        ...
        <div class="mb-4">
          <h3 class="h5">Sale invoice additions</h3>
          <div>
        ...
        {{-- Purchasee additions --}}
        <div class="mb-4">
          <h3 class="h5">Purchase additions</h3>
          <div>
        ...
        {{-- Expense additions --}}
        <div class="mb-4">
          <h3 class="h5">Expense additions</h3>
          <div>
