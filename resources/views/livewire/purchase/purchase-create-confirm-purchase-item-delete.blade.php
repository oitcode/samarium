<div style="width: 1000px !important; font-size: 1.3rem;">
      <div class="modal enter" tabindex="-1" role="dialog" data-backdrop="static" id="purchaseItemDeleteConfirmModal">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body p-0">
                    ...
                    <div class="d-flex justify-content-center h-100 text-secondary">
                      <div class="d-flex justify-content-center align-self-center">
                        <h3 class="h5 font-weight-bold p-3">
                          Purchase Item ID: {{ $purchaseItem->purchase_item_id }}
                        </h3>
                      </div>
                    </div>
                  </div>
              ...
              <div class="mx-2 ml-3 mt-3 mb-3">
                <button wire:click="deletePurchaseItem({{ $purchaseItem }})"
                    class="btn btn-sm btn-danger mr-3 p-2"
                    data-dismiss="modal"
                    style="font-size: 1.2rem;">
                  Remove
                </button>
                <button wire:click="$dispatch('exitConfirmPurchaseItemDelete')"
      ...
      <script>
          ...
          $(document).ready(function () {
             $('#purchaseItemDeleteConfirmModal').modal('show');
          });
      </script>
</div>
