      ...
      @if ($webpages != null && count($webpages) > 0)
        @foreach ($webpages as $webpage)
          <x-table-row-component>
            ...
            <td class="text-right">
              <button class="btn btn-primary px-2 py-1" wire:click="$dispatch('displayWebpage', { webpageId : {{ $webpage->webpage_id }} })">
                <i class="fas fa-pencil-alt"></i>
              </button>
              <button class="btn btn-success px-2 py-1" wire:click="$dispatch('displayWebpage', { webpageId : {{ $webpage->webpage_id }} })">
