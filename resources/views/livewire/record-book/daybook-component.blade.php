    ...
    <div class="col-md-6">
      ...
      @else
        ...
        <div class="row-rm">
          <div class="col-md-12-rm">
            @if ( true {{--$saleInvoices != null && count($saleInvoices) > 0--}})
              ...
              <div class="table-responsive d-none d-md-block mb-3">
                <table class="table table-hover-rm shadow-sm border mb-0 bg-success text-white-rm">
                  <thead>
                    <tr class="bg-success text-white-rm">
                      ...
                      <th class="o-heading" class="" style="width: 200px;">
                  ...
                  <tbody class="bg-white">
                    @if (count($saleInvoices) > 0)
                      @foreach ($saleInvoices as $saleInvoice)
                        <tr class="bg-success text-white-rm" role="button" wire:click="displaySaleInvoice({{ $saleInvoice }})">
                          <td class="" wire:click="" role="button">
            ...
            @else
              <div class="text-secondary-rm py-3 px-3">
                No sales.
              </div>
            @endif
            ...
            <div class="border mb-3 bg-success">
              ...
              <div class="row m-0 p-3 bg-success text-dark-rm d-flex">
          ...
          <div class="col-md-12-rm border bg-success">
