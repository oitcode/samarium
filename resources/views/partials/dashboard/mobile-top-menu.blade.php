    ...
    <ul class="navbar-nav mr-auto">
      ...
      @if (preg_match("/shop/i", env('MODULES')))
        <li class="nav-item dropdown bg-success text-white p-3 border">
          <a class="nav-link dropdown-toggle text-white" href="#" id="mobTopMenuShopDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="fas fa-list text-secondry mr-2"></i>
            Shop
          </a>
          <div class="dropdown-menu" aria-labelledby="mobTopMenuShopDropdown">
            <a class="dropdown-item py-2" href="{{ route('sale') }}">
            ...
            <a class="dropdown-item py-2" href="{{ route('daybook') }}">
              <i class="fas fa-book mr-3"></i>
              Daybook
            </a>
            <a class="dropdown-item py-2" href="{{ route('weekbook') }}">
              <i class="fas fa-book mr-3"></i>
              Weekbook
            </a>
            <a class="dropdown-item py-2" href="{{ route('online-order') }}">
