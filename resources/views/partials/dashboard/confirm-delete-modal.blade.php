<div style="width: 1000px !important; font-size: 1.3rem;">
  <div class="modal enter" tabindex="-1" role="dialog" data-backdrop="static" id="{{ $modalId }}">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body p-0">
          ...
          <div class="mx-2 ml-3 mt-3 mb-3">
            <button wire:click="$dispatch('deleteInstance', {{ $todo->todo_id }})"
                class="btn btn-sm btn-danger mr-3 p-2"
                data-dismiss="modal"
                style="font-size: 1.2rem;">
              Remove
            </button>
            <button wire:click="$dispatch('exitConfirmDelete')"
